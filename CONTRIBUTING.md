...
Third-party dependencies and their licences are listed in [THIRD-PARTY-NOTICES/](THIRD-PARTY-NOTICES/), which is generated by `make notices` — regenerate it after any dependency change, or CI fails. Attribution and trademark notices are in [NOTICE](NOTICE).
