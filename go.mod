module github.com/amagioss/opentams
...
// Security version floors on transitive dependencies.
//
// The five modules below are genuinely indirect -- no OpenTAMS package
// imports them -- but they are held above the version the module graph
// would otherwise select, because the lower versions carry advisories
// govulncheck reports as reachable from our code. Do not lower them to
// "what the graph needs"; that is the state this pins away from.
//
